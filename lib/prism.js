/* PrismJS 1.20.0
https://prismjs.com/download.html#themes=prism-dark&languages=markup+css+clike+javascript+bash+c+cpp+dart+docker+git+json+markup-templating+nginx+php+python+jsx+tsx+sql+typescript */
var _self =
...
!(function (e) {
	...
	(e.languages.cpp = e.languages.extend('c', {
		'class-name': [
			{
				pattern: RegExp(
					'(\\b(?:class|enum|struct|typename)\\s+)(?!<keyword>)\\w+'.replace(
						/<keyword>/g,
						function () {
							return t.source;
						}
